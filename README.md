...
* Choose criteria to narrow down the DataFrame to find your ideal weather condition. For example:
  ...
  * **Note:** Feel free to adjust to your specifications but be sure to limit the number of rows returned by your API requests to a reasonable number, somewhere around 10.
